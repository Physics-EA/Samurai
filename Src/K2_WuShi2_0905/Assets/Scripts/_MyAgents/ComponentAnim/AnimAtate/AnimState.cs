...
public class AnimState : System.Object
{
    ...
    virtual public void OnActivate(ActionBase action) // state is being activated
    {
	...
	virtual public bool HandleNewAction(ActionBase action) { return false; } // new action is comming..
    ...
    virtual protected void Initialize(ActionBase action)
    {
    ...
    protected bool Move(Vector3 velocity, bool slide = true )
    {
        ...
        CollisionFlags flags = Owner.GetComponent<CharacterController>().Move(velocity);
