...
public class AnimSetPlayer : AnimSet
{
    ...
    void Awake()
    {
      ...
      //  anims["hidSwordRun"].blendMode = AnimationBlendMode.Additive;
        ...
        //  把玩家整体攻速调整快些
        // combo XXXXXX
        anims["attackX"].speed = 1.5f;
        anims["attackXX"].speed = 1.2f;
        anims["attackXXX"].speed = 1.2f;
        anims["attackXXXX"].speed = 1.2f;
        anims["attackXXXXX"].speed = 1.2f;
        ...
        // combo OOOXX
        anims["attackO"].speed = 1.3f;
        anims["attackOO"].speed = 1.5f;
        anims["attackOOO"].speed = 1.2f;
        anims["attackOOOX"].speed = 1.1f;
        anims["attackOOOXX"].speed = 1.5f;
        ...
        // COMBO X00XX
        anims["attackXO"].speed = 1.5f;
        anims["attackXOO"].speed = 1.8f;
        anims["attackXOOX"].speed = 1.8f;
        anims["attackXOOXX"].speed = 1.8f;
        ...
        // COMBO XX0XX
        anims["attackXXO"].speed = 1.5f;
        anims["attackXXOX"].speed = 1.8f;
        anims["attackXXOXX"].speed = 1.9f;
        ...
        // Combo OOXOO
        anims["attackOOX"].speed = 1.5f;
        anims["attackOOXO"].speed = 1.5f;
        ...
        // COMBO OXOOO
        anims["attackOX"].speed = 1.6f;
        anims["attackOXO"].speed = 1.8f;
        anims["attackOXOX"].speed = 1.5f;
        anims["attackOXOXO"].speed = 1.5f;
